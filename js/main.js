...
function handleSuccess(stream) {
  ...
  video.addEventListener('abort', () => alert('video abort'))
  video.addEventListener('canplay', () => alert('video canplay'))
  video.addEventListener('canplaythrough', () => alert('video canplaythrough'))
  video.addEventListener('durationchange', () => alert('video durationchange'))
  video.addEventListener('emptied', () => alert('video emptied'))
  video.addEventListener('ended', () => alert('video ended'))
  video.addEventListener('error', () => alert('video error'))
  video.addEventListener('loadeddata', () => alert('video loadeddata'))
  video.addEventListener('loadedmetadata', () => alert('video loadedmetadata'))
  video.addEventListener('loadstart', () => alert('video loadstart'))
  video.addEventListener('pause', () => alert('video pause'))
  video.addEventListener('play', () => alert('video play'))
  video.addEventListener('playing', () => alert('video playing'))
  video.addEventListener('progress', () => alert('video progress'))
  video.addEventListener('ratechange', () => alert('video ratechange'))
  video.addEventListener('resize', () => alert('video resize'))
  video.addEventListener('seeked', () => alert('video seeked'))
  video.addEventListener('seeking', () => alert('video seeking'))
  video.addEventListener('stalled', () => alert('video stalled'))
  video.addEventListener('suspend', () => alert('video suspend'))
  video.addEventListener('timeupdate', () => alert('video timeupdate'))
  video.addEventListener('volumechange', () => alert('video volumechange'))
  video.addEventListener('waiting', () => alert('video waiting'))
